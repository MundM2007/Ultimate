...
<recipetype:create:crushing>.addRecipe("create.milling/cobalt_ore", [<item:emendatusenigmatica:cobalt_crushed> % 100, <item:emendatusenigmatica:cobalt_crushed> * 2 % 30], <tag:items:forge:ores/cobalt>);
