...
//
	...
	//DIAMOND
	event.addSimpleBlock('#forge:ores/diamond', 'minecraft:diamond')

	//EMERALD
	event.addSimpleBlock('#forge:ores/emerald', 'minecraft:emerald')

	//LAPIS LAZULI
	event.addSimpleBlock('#forge:ores/lapis', 'minecraft:lapis_lazuli')

	//REDSTONE
	event.addSimpleBlock('#forge:ores/redstone', 'minecraft:redstone')
