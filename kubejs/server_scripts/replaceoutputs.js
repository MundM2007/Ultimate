...
//COPPER why the fuck do every mod add copper?
	...
	event.replaceOutput({}, 'bno:copper_block', 'emendatusenigmatica:copper_block')
	//Copper nugget
...
//ALUMINUM this one i feared too. aluminum, aluminium, bauxite? wtf?
	...
	event.replaceOutput({}, 'bno:aluminum_ingot', 'emendatusenigmatica:aluminum_ingot')
	...
	event.replaceOutput({}, 'bno:aluminum_block', 'emendatusenigmatica:aluminum_block')
...
//SILVER
	...
	event.replaceOutput({}, 'bno:silver_block', 'emendatusenigmatica:silver_block')
	//Silver nugget
...
//LEAD
	...
	event.replaceOutput({}, 'bno:lead_block', 'emendatusenigmatica:lead_block')
	//Lead nugget
...
//NICKEL
	...
	event.replaceOutput({}, 'bno:nickel_block', 'emendatusenigmatica:nickel_block')
	//Nickel nugget
...
//URANIUM
	...
	event.replaceOutput({}, 'bno:uranium_block', 'emendatusenigmatica:uranium_block')
	//Uranium nugget
...
//OSMIUM
	...
	event.replaceOutput({}, 'bno:osmium_block', 'emendatusenigmatica:osmium_block')
	//Osmium nugget
...
//TIN
	...
	event.replaceOutput({}, 'bno:tin_ingot', 'emendatusenigmatica:tin_ingot')
	...
	event.replaceOutput({}, 'bno:tin_block', 'emendatusenigmatica:tin_block')
	//Tin nugget
