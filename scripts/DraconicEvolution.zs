...
craftingTable.addShaped("draconic_core_1", <item:draconicevolution:draconium_core>, [
	...
	[<item:enderioalloys:item_alloy_ingot_melodic_alloy>, <item:minecraft:diamond>, <item:naturesaura:sky_ingot>], 
...
craftingTable.addShaped("draconic_core_2", <item:draconicevolution:draconium_core>, [
	...
	[<item:draconicevolution:draconium_ingot>, <item:naturesaura:infused_iron>, <item:draconicevolution:draconium_ingot>]
]);
...
mods.extendedcrafting.TableCrafting.addShaped("draconium_chest", <item:draconicevolution:draconium_chest>, [
	[<item:draconicevolution:draconium_block>, <item:draconicevolution:draconium_ingot>, <item:ironchest:diamond_chest>, <item:draconicevolution:draconium_ingot>, <item:draconicevolution:draconium_block>], 
	[<item:draconicevolution:draconium_ingot>, <item:minecraft:crafting_table>, <item:draconicevolution:wyvern_energy_core>, <item:minecraft:crafting_table>, <item:draconicevolution:draconium_ingot>], 
	[<item:ironchest:diamond_chest>, <item:draconicevolution:wyvern_core>, <item:ironfurnaces:netherite_furnace>, <item:draconicevolution:wyvern_core>, <item:ironchest:diamond_chest>], 
	[<item:draconicevolution:draconium_ingot>, <item:minecraft:crafting_table>, <item:draconicevolution:wyvern_energy_core>, <item:minecraft:crafting_table>, <item:draconicevolution:draconium_ingot>], 
	[<item:draconicevolution:draconium_block>, <item:draconicevolution:draconium_ingot>, <item:ironchest:diamond_chest>, <item:draconicevolution:draconium_ingot>, <item:draconicevolution:draconium_block>]
]);