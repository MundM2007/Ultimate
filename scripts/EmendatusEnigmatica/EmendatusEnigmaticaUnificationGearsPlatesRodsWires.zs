...
<recipetype:thermal:press>.addRecipe("thermal_ruby_gear", [<item:emendatusenigmatica:ruby_gear> % 100], <fluid:minecraft:empty>, [<item:emendatusenigmatica:ruby_gem> * 4, <item:thermal:press_gear_die>], 2400);
<recipetype:thermal:press>.addRecipe("thermal_sapphire_gear", [<item:emendatusenigmatica:sapphire_gear> % 100], <fluid:minecraft:empty>, [<item:emendatusenigmatica:sapphire_gem> * 4, <item:thermal:press_gear_die>], 2400);
<recipetype:thermal:press>.addRecipe("thermal_peridot_gear", [<item:emendatusenigmatica:peridot_gear> % 100], <fluid:minecraft:empty>, [<item:emendatusenigmatica:peridot_gem> * 4, <item:thermal:press_gear_die>], 2400);
...
<recipetype:thermal:press>.addRecipe("thermal_ruby_plate", [<item:emendatusenigmatica:ruby_plate> % 100], <fluid:minecraft:empty>, [<item:emendatusenigmatica:ruby_gem>], 2400);
<recipetype:thermal:press>.addRecipe("thermal_sapphire_plate", [<item:emendatusenigmatica:sapphire_plate> % 100], <fluid:minecraft:empty>, [<item:emendatusenigmatica:sapphire_gem>], 2400);
<recipetype:thermal:press>.addRecipe("thermal_peridot_plate", [<item:emendatusenigmatica:peridot_plate> % 100], <fluid:minecraft:empty>, [<item:emendatusenigmatica:peridot_gem>], 2400);
...
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/iron/rod", <item:emendatusenigmatica:iron_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_iron> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/gold/rod", <item:emendatusenigmatica:gold_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_gold> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/gem/diamond/rod", <item:emendatusenigmatica:diamond_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_diamond> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/gem/emerald/rod", <item:emendatusenigmatica:emerald_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_emerald> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/gem/lapis/rod", <item:emendatusenigmatica:lapis_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_lapis> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/copper/rod", <item:emendatusenigmatica:copper_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_copper> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/aluminum/rod", <item:emendatusenigmatica:aluminum_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_aluminum> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/silver/rod", <item:emendatusenigmatica:silver_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_silver> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/lead/rod", <item:emendatusenigmatica:lead_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_lead> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/nickel/rod", <item:emendatusenigmatica:nickel_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_nickel> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/uranium/rod", <item:emendatusenigmatica:uranium_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_uranium> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/osmium/rod", <item:emendatusenigmatica:osmium_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_osmium> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/tin/rod", <item:emendatusenigmatica:tin_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_tin> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/zinc/rod", <item:emendatusenigmatica:zinc_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_zinc> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/cobalt/rod", <item:emendatusenigmatica:cobalt_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_cobalt> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/gem/ruby/rod", <item:emendatusenigmatica:ruby_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_ruby> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/gem/sapphire/rod", <item:emendatusenigmatica:sapphire_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_sapphire> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/gem/peridot/rod", <item:emendatusenigmatica:peridot_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_peridot> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/bronze/rod", <item:emendatusenigmatica:bronze_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_bronze> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/brass/rod", <item:emendatusenigmatica:brass_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_brass> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/constantan/rod", <item:emendatusenigmatica:constantan_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_constantan> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/electrum/rod", <item:emendatusenigmatica:electrum_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_electrum> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/steel/rod", <item:emendatusenigmatica:steel_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_steel> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/invar/rod", <item:emendatusenigmatica:invar_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_invar> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/signalum/rod", <item:emendatusenigmatica:signalum_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_signalum> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/lumium/rod", <item:emendatusenigmatica:lumium_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_lumium> * 288, 3500);
<recipetype:thermal:chiller>.addRecipe("thermal.chiller/metal/enderium/rod", <item:emendatusenigmatica:enderium_rod>, <item:thermal:chiller_rod_cast>, <fluid:emendatusenigmatica:molten_enderium> * 288, 3500);
...
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("tconstruct.smeltery/casting/metal/copper/wire_gold_cast", <item:tconstruct:wire_cast>, <fluid:emendatusenigmatica:molten_copper> * 72, <item:createaddition:copper_wire>, 40, false, false);
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("tconstruct.smeltery/casting/metal/copper/wire_sand_cast", <item:tconstruct:wire_sand_cast>, <fluid:emendatusenigmatica:molten_copper> * 72, <item:createaddition:copper_wire>, 40, true, false);
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("tconstruct.smeltery/casting/metal/copper/wire_red_sand_cast", <item:tconstruct:wire_red_sand_cast>, <fluid:emendatusenigmatica:molten_copper> * 72, <item:createaddition:copper_wire>, 40, true, false);

villagerTrades.addTrade(<profession:immersiveengineering:electrician>, 1, <item:createaddition:copper_wire> * 14, <item:minecraft:emerald>, 16, 4, 0.05);
