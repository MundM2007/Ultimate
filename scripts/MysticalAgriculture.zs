...
val nitrocrystalCrop = crops.create("misticalagriculture:nitro_crystal", <item:mysticalagriculture:nitro_crystal_seeds>, <blockstate:mysticalagriculture:nitro_crystal_crop>, 1800, "farmland");
nitrocrystalCrop.addDrop(<item:mysticalagriculture:nitro_crystal_essence>, 0.75);
nitrocrystalCrop.addDrop(<item:mysticalagriculture:nitro_crystal_seeds>, 0.05);
nitrocrystalCrop.addDrop(<item:mysticalagriculture:fertilized_essence>, 0.01);

val awakeneddraconiumCrop = crops.create("misticalagriculture:awakened_draconium", <item:mysticalagriculture:awakened_draconium_seeds>, <blockstate:mysticalagriculture:awakened_draconium_crop>, 1800, "farmland");
awakeneddraconiumCrop.addDrop(<item:mysticalagriculture:awakened_draconium_essence>, 0.75);
awakeneddraconiumCrop.addDrop(<item:mysticalagriculture:awakened_draconium_seeds>, 0.05);
awakeneddraconiumCrop.addDrop(<item:mysticalagriculture:fertilized_essence>, 0.01);
...
limestoneCrop.addDrop(<item:mysticalagriculture:livingrock_essence>, 0.75);
limestoneCrop.addDrop(<item:mysticalagriculture:livingrock_seeds>, 0.05);
