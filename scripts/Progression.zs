...
craftingTable.addShaped("projectex.energy_link", <item:projectex:energy_link>, [
	[<item:projecte:low_covalence_dust>, <item:projecte:medium_covalence_dust>, <item:projecte:high_covalence_dust>], 
	[<item:projectex:pink_matter>, <item:projectex:pink_matter>, <item:projectex:pink_matter>], 
	[<item:projecte:high_covalence_dust>, <item:projecte:medium_covalence_dust>, <item:projecte:low_covalence_dust>]
]);
craftingTable.addShaped("projectex.personal_link", <item:projectex:personal_link>, [
	[<item:projectex:violet_matter>, <item:projectex:energy_link>, <item:projectex:violet_matter>], 
	[<item:projectex:energy_link>, <item:projecte:condenser_mk2>, <item:projectex:energy_link>], 
	[<item:projectex:violet_matter>, <item:projectex:energy_link>, <item:projectex:violet_matter>]
]);
...
mods.extendedcrafting.TableCrafting.addShaped("steel_casing_custom", 0, <item:mekanism:steel_casing>, [
	...
	[<item:immersivepetroleum:petcoke>, <item:create:refined_radiance>, <item:industrialforegoing:processing_addon_2>, <item:create:shadow_steel>, <item:immersivepetroleum:petcoke>], 
